...
import { App, Card, Col, Popover, Row } from "antd";
import { useState } from "react";
import useStyles from "@/pages/form/advanced-form/style.style";
...
const AdvancedFormPage = () => {
  ...
  const getErrorInfo = (errors: ErrorField[]) => {
    ...
    const errorList = errors.map((err) => {
      if (!err.errors.length) return null;
      ...
      <span className={styles.errorIcon}>
        <Popover
          ...
          getPopupContainer={(trigger: HTMLElement) =>
            trigger.parentNode ? (trigger.parentNode as HTMLElement) : trigger
          }
        >
          <CloseCircleOutlined />
        </Popover>
