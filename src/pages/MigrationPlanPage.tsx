import { CheckCircleFilled, ClockCircleOutlined, ToolOutlined } from "@ant-design/icons";
...
const phases = [
  {
    ...
    tasks: ["Vite 配置已添加", "默认脚本已切到 Vite", "旧的 Umi 启动命令已经移除"],
  },
  {
    title: "Phase 2: 页面脱钩",
    status: "active",
  ...
  },
  {
    ...
    tasks: ["替换 mock / proxy / 请求层", "清理 config/routes.ts 等旧入口", "移除旧运行时相关依赖"],
  },
];
    ...
    <PageContainer>
      <Card variant="borderless" style={{ marginBottom: 24 }}>
        ...
        <Typography.Paragraph type="secondary">
          当前策略不是一次性硬切，而是先把 Vite 应用壳搭起来，再用一批一批页面迁出的方式降低风险。
          ...
          return (
            <Col xs={24} lg={8} key={phase.title}>
              <Card variant="borderless" className="plan-card">
                ...
                <Typography.Paragraph type="secondary">{phase.description}</Typography.Paragraph>
                <List
                  size="small"
