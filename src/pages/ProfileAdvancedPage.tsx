...
import useStyles from "@/pages/profile/advanced/style.style";
...
const ProfileAdvancedPage = () => {
  ...
  const { data = {}, loading } = useAsyncData<AdvancedProfileData>(fetchAdvancedProfile, []);
  ...
  return (
    <PageContainer
      ...
      onTabChange={(tabActiveKey) => setTabStatus((state) => ({ ...state, tabActiveKey }))}
      tabList={[
        { key: "detail", tab: "详情" },
        { key: "rule", tab: "规则" },
      ]}
    >
      <div className={styles.main}>
        <GridContent>
          ...
          <Card title="用户信息" style={{ marginBottom: 24 }} variant="borderless">
          ...
          <Card title="用户近半年来电记录" style={{ marginBottom: 24 }} variant="borderless">
            <Empty />
          </Card>
          <Card
            variant="borderless"
            ...
            onTabChange={(key) =>
              setTabStatus((state) => ({
                ...state,
                operationKey: key as "tab1" | "tab2" | "tab3",
              }))
            }
          >
...
export default ProfileAdvancedPage;
