...
import { addRuleItem, queryRuleList, removeRuleItems, updateRuleItem } from "../data/ruleTable";
  ...
  return (
    <PageContainer>
      <ProTable<TableListItem, TableListParams>
        ...
        toolBarRender={() => [<RuleCreateForm key="create" reload={actionRef.current?.reload} />]}
