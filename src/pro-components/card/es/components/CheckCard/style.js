            ...
            _defineProperty(
                ...
                _defineProperty(
                  _defineProperty(
                    _defineProperty(
                      _defineProperty(
                        _token$componentCls,
                        "".concat(token.componentCls, "-loading"),
                        {
                          overflow: "hidden",
                          userSelect: "none",
                          "&-content": {
                    ...
                    "&-checked",
                    _objectSpread(
                      _objectSpread({}, proCheckCardActive(token)),
                      {},
                      {
                        "&:after": {
                          opacity: 1,
                          border: ""
                            .concat(token.borderRadius + 4, "px solid ")
                            .concat(token.colorPrimary),
                          borderBlockEnd: "".concat(
              ...
              "&-checked&-disabled",
              {
                "&:after": {
                  ...
                  border: ""
                    .concat(token.borderRadius + 4, "px solid ")
                    .concat(token.colorTextDisabled),
                  borderBlockEnd: "".concat(token.borderRadius + 4, "px  solid transparent"),
                  borderInlineStart: "".concat(token.borderRadius + 4, "px  solid transparent"),
                  borderStartEndRadius: "".concat(token.borderRadius, "px"),
                  content: "''",
...
export function useStyle(prefixCls) {
  return useAntdStyle("CheckCard", function (token) {
    var proListToken = _objectSpread(
      _objectSpread({}, token),
      {},
      {
