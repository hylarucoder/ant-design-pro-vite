...
var CheckCard = function CheckCard(props) {
  ...
  var handleClick = function handleClick(e) {
    ...
    checkCardGroup === null ||
      checkCardGroup === void 0 ||
      (_checkCardGroup$toggl = checkCardGroup.toggleOption) === null ||
      _checkCardGroup$toggl === void 0 ||
      _checkCardGroup$toggl.call(checkCardGroup, {
        value: props.value,
      });
  ...
  useEffect(
    function () {
      ...
      checkCardGroup === null ||
        checkCardGroup === void 0 ||
        (_checkCardGroup$regis = checkCardGroup.registerValue) === null ||
        _checkCardGroup$regis === void 0 ||
        _checkCardGroup$regis.call(checkCardGroup, props.value);
      return function () {
        var _checkCardGroup$cance;
        return checkCardGroup === null ||
          checkCardGroup === void 0 ||
          (_checkCardGroup$cance = checkCardGroup.cancelValue) === null ||
          _checkCardGroup$cance === void 0
          ? void 0
          : _checkCardGroup$cance.call(checkCardGroup, props.value);
      };
  ...
  if (checkCardGroup) {
    ...
    var isChecked = checkCardGroup.multiple
      ? (_checkCardGroup$value = checkCardGroup.value) === null || _checkCardGroup$value === void 0
        ? void 0
        : _checkCardGroup$value.includes(props.value)
      ...
      _defineProperty(
        _defineProperty(
          _defineProperty(
            _defineProperty(
              _defineProperty(
                _defineProperty({}, "".concat(prefixCls, "-loading"), cardLoading),
  ...
  var metaDom = useMemo(
    function () {
      ...
      var avatarDom = avatar
        ...
        : null;
      var headerDom =
        (title !== null && title !== void 0 ? title : extra) != null &&
        /*#__PURE__*/ _jsxs("div", {
              ...
              children: [
                /*#__PURE__*/ _jsx("div", {
                  className: classNames(
                    ...
                    _defineProperty(
                      {},
                      "".concat(prefixCls, "-title-with-ellipsis"),
                      typeof title === "string",
                    ),
                  ),
                  children: title,
      ...
      var descriptionDom = description
        ...
        : null;
      var metaClass = classNames(
        "".concat(prefixCls, "-content"),
        hashId,
        _defineProperty(
          {},
          "".concat(prefixCls, "-avatar-header"),
