...
var Card = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  // 修改组合传给antd tabs的参数
  // @ts-ignore
  var ModifyTabItemsContent = useLegacyItems(
    tabs === null || tabs === void 0 ? void 0 : tabs.items,
    children,
    tabs,
  );
    ...
    if (_typeof(colSpan) === "object") {
      for (var i = 0; i < responsiveArray.length; i += 1) {
        ...
        if (
          ...
          screens !== void 0 &&
          screens[breakpoint] &&
          (colSpan === null || colSpan === void 0 ? void 0 : colSpan[breakpoint]) !== undefined
        ) {
  ...
  var childrenModified = childrenArray.map(function (element, index) {
    ...
    if (
      ...
      _element$type !== void 0 &&
      _element$type.isProCard
    ) {
      containProCard = true;
      ...
      var columnClassName = classNames(
        ["".concat(prefixCls, "-col")],
        hashId,
        _defineProperty(
          _defineProperty(
            _defineProperty(
              {},
              "".concat(prefixCls, "-split-vertical"),
              split === "vertical" && index !== childrenArray.length - 1,
            ),
            "".concat(prefixCls, "-split-horizontal"),
            split === "horizontal" && index !== childrenArray.length - 1,
          ),
          "".concat(prefixCls, "-col-").concat(span),
          typeof span === "number" && span >= 0 && span <= 24,
        ),
      );
      var wrappedElement = wrapSSR(
        /*#__PURE__*/ _jsx("div", {
          style: _objectSpread(
            _objectSpread(
              _objectSpread(
                _objectSpread({}, colSpanStyle),
      ...
      return /*#__PURE__*/ React.cloneElement(wrappedElement, {
        key: "pro-card-col-".concat(
          (element === null || element === void 0 ? void 0 : element.key) || index,
        ),
      });
    }
    return element;
  });
  var cardCls = classNames(
    "".concat(prefixCls),
    className,
    hashId,
    ((_classNames2 = {}),
    _defineProperty(
      _defineProperty(
        _defineProperty(
            ...
            _defineProperty(
              _defineProperty(
                _defineProperty(
                  _defineProperty(
                    _defineProperty(
                      _defineProperty(_classNames2, "".concat(prefixCls, "-border"), bordered),
                      "".concat(prefixCls, "-box-shadow"),
                      boxShadow,
                    ),
                    "".concat(prefixCls, "-contain-card"),
                    containProCard,
                  ),
          ...
          "".concat(prefixCls, "-size-").concat(size),
          size,
        ),
        "".concat(prefixCls, "-type-").concat(type),
        type,
      ),
      "".concat(prefixCls, "-collapse"),
      collapsed,
    ),
    _defineProperty(_classNames2, "".concat(prefixCls, "-checked"), checked)),
  );
  var bodyCls = classNames(
    ...
    _defineProperty(
      _defineProperty(
        _defineProperty({}, "".concat(prefixCls, "-body-center"), layout === "center"),
        "".concat(prefixCls, "-body-direction-column"),
        split === "horizontal" || direction === "column",
      ),
      "".concat(prefixCls, "-body-wrap"),
      wrap && containProCard,
    ),
  );
  var cardBodyStyle = bodyStyle;
  var loadingDOM = /*#__PURE__*/ React.isValidElement(loading)
    ? loading
    : /*#__PURE__*/ _jsx(Loading, {
        prefix: prefixCls,
        style:
          (bodyStyle === null || bodyStyle === void 0 ? void 0 : bodyStyle.padding) === 0 ||
          (bodyStyle === null || bodyStyle === void 0 ? void 0 : bodyStyle.padding) === "0px"
            ? {
                padding: 24,
              }
            : undefined,
        ...
        _objectSpread(
          {
            ...
            onClick: function onClick(e) {
              ...
              rest === null ||
                rest === void 0 ||
                (_rest$onClick = rest.onClick) === null ||
                _rest$onClick === void 0 ||
                _rest$onClick.call(rest, e);
            },
          },
              ...
              /*#__PURE__*/ _jsxs("div", {
                className: classNames(
                  ...
                  _defineProperty(
                    _defineProperty(
                      {},
                      "".concat(prefixCls, "-header-border"),
                      headerBordered || type === "inner",
                    ),
                    "".concat(prefixCls, "-header-collapsible"),
                    collapsibleButton,
                  ),
                ),
                style: headStyle,
