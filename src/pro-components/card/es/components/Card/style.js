...
var genProCardStyle = function genProCardStyle(token) {
  ...
  return _defineProperty(
    _defineProperty(
      _defineProperty(
        ...
        _objectSpread(
          _objectSpread(
            ...
            resetComponent === null || resetComponent === void 0 ? void 0 : resetComponent(token),
          ),
          {},
          _defineProperty(
            _defineProperty(
              _defineProperty(
                _defineProperty(
                    ...
                    _defineProperty(
                      _defineProperty(
                        _defineProperty(
                            ...
                            _defineProperty(
                              {
                                ...
                                "&-border": {
                                  border: ""
                                    .concat(token.lineWidth, "px ")
                                    .concat(token.lineType, " ")
                                    .concat(token.colorSplit),
                                },
                                ...
                                "&-checked": _objectSpread(
                                  _objectSpread({}, genActiveStyle(token)),
                                  {},
                                  {
                                    "&::after": {
                                      visibility: "visible",
                          ...
                          "&&-collapse",
                          _defineProperty({}, "> ".concat(componentCls), {
                            "&-header": {
                              paddingBlockEnd: token.padding,
                              borderBlockEnd: 0,
                            },
                  ...
                  "".concat(componentCls, "-type-inner"),
                  _defineProperty({}, "".concat(componentCls, "-header"), {
      ...
      "".concat(componentCls, "-col"),
      _defineProperty(
        _defineProperty({}, "&".concat(componentCls, "-split-vertical"), {
          borderInlineEnd: ""
            .concat(token.lineWidth, "px ")
            .concat(token.lineType, " ")
            .concat(token.colorSplit),
    ...
    _defineProperty(
      _defineProperty(
        _defineProperty(
          _defineProperty(
            _defineProperty(
              _defineProperty(
                {},
                "".concat(token.antCls, "-tabs-top > ").concat(token.antCls, "-tabs-nav"),
                _defineProperty(
                  {
                    marginBlockEnd: 0,
                  },
              ...
              "".concat(token.antCls, "-tabs-bottom > ").concat(token.antCls, "-tabs-nav"),
              _defineProperty(
                {
                  marginBlockEnd: 0,
                },
            ...
            "".concat(token.antCls, "-tabs-left"),
            _defineProperty(
              {},
              "".concat(token.antCls, "-tabs-content-holder"),
              _defineProperty(
                {},
                "".concat(token.antCls, "-tabs-content"),
                _defineProperty({}, "".concat(token.antCls, "-tabs-tabpane"), {
                  paddingInlineStart: 0,
                }),
              ),
            ),
          ),
          "".concat(token.antCls, "-tabs-left > ").concat(token.antCls, "-tabs-nav"),
          _defineProperty(
            {
              marginInlineEnd: 0,
            },
        ...
        "".concat(token.antCls, "-tabs-right"),
        _defineProperty(
          {},
          "".concat(token.antCls, "-tabs-content-holder"),
          _defineProperty(
      ...
      "".concat(token.antCls, "-tabs-right > ").concat(token.antCls, "-tabs-nav"),
      _defineProperty({}, "".concat(token.antCls, "-tabs-nav-list"), {
        paddingBlockStart: token.padding,
      }),
    ),
  );
...
export default function useStyle(prefixCls) {
  return useAntdStyle("ProCard", function (token) {
    var proCardToken = _objectSpread(
      _objectSpread({}, token),
      {},
      {
