...
var StatisticSkeleton = function StatisticSkeleton(_ref2) {
  ...
  var colSize =
    Object.keys(col).filter(function (key) {
      return col[key] === true;
    })[0] || "md";
...
var ListPageSkeleton = function ListPageSkeleton(_ref7) {
  ...
  return /*#__PURE__*/ _jsxs("div", {
    ...
    children: [
      pageHeader !== false &&
        /*#__PURE__*/ _jsx(PageHeaderSkeleton, {
          active: active,
        }),
      statistic !== false &&
        /*#__PURE__*/ _jsx(StatisticSkeleton, {
          size: statistic,
          active: active,
        }),
      (toolbar !== false || list !== false) &&
        /*#__PURE__*/ _jsxs(Card, {
          ...
          children: [
            toolbar !== false &&
              /*#__PURE__*/ _jsx(ListToolbarSkeleton, {
                active: active,
              }),
            list !== false &&
              /*#__PURE__*/ _jsx(ListSkeleton, {
                size: list,
                active: active,
