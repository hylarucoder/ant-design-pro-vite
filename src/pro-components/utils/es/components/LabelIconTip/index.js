...
export var LabelIconTip = /*#__PURE__*/ React.memo(function (props) {
  ...
  var tooltipProps =
    typeof tooltip === "string" || /*#__PURE__*/ React.isValidElement(tooltip)
      ? {
          title: tooltip,
        }
      : tooltip;
  var icon =
    (tooltipProps === null || tooltipProps === void 0 ? void 0 : tooltipProps.icon) ||
    /*#__PURE__*/ _jsx(InfoCircleOutlined, {});
  return wrapSSR(
    /*#__PURE__*/ _jsxs("div", {
      ...
      children: [
        /*#__PURE__*/ _jsx("div", {
          className: classNames(
            ...
            hashId,
            _defineProperty({}, "".concat(className, "-title-ellipsis"), ellipsis),
          ),
          children: label,
        }),
        subTitle &&
