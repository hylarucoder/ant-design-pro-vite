...
var InlineErrorFormItemPopover = function InlineErrorFormItemPopover(_ref) {
  ...
  var popoverOpenProps = openVisibleCompatible(
  ...
  return /*#__PURE__*/ _jsx(
    ...
    _objectSpread(
      _objectSpread(
        _objectSpread(
          {
            trigger: (popoverProps === null || popoverProps === void 0
              ? void 0
        ...
        {},
        {
          getPopupContainer:
            popoverProps === null || popoverProps === void 0
              ? void 0
              : popoverProps.getPopupContainer,
          getTooltipContainer:
            popoverProps === null || popoverProps === void 0
              ? void 0
              : popoverProps.getTooltipContainer,
          content: wrapSSR(
            /*#__PURE__*/ _jsx("div", {
              className: ""
                .concat(prefixCls, "-form-item ")
                .concat(hashId, " ")
                .concat(token.hashId)
                .trim(),
              style: {
              ...
              children: /*#__PURE__*/ _jsxs("div", {
                className: ""
                  .concat(prefixCls, "-form-item-with-help ")
                  .concat(hashId, " ")
                  .concat(token.hashId)
                  .trim(),
...
var InternalFormItemFunction = function InternalFormItemFunction(_ref2) {
  ...
  return /*#__PURE__*/ _jsx(
    ...
    _objectSpread(
      ...
      {
        style: _objectSpread(
          _objectSpread({}, FIX_INLINE_STYLE),
