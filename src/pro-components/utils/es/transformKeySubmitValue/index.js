    ...
    Object.keys(tempValues).forEach(function (entityKey) {
      var transformForArray = function transformForArray(transformList, subItemValue) {
        ...
        transformList.forEach(function (transform, idx) {
          // 如果不存在直接返回
          if (!transform) return;
          var subTransformItem =
            subItemValue === null || subItemValue === void 0 ? void 0 : subItemValue[idx];
          ...
          if (_typeof(transform) === "object" && !Array.isArray(transform)) {
            Object.keys(transform).forEach(function (transformArrayItem) {
              var subTransformItemValue =
                subTransformItem === null || subTransformItem === void 0
                  ? void 0
                  : subTransformItem[transformArrayItem];
              if (typeof transform[transformArrayItem] === "function" && subTransformItemValue) {
                var res = transform[transformArrayItem](
                  subTransformItem[transformArrayItem],
                  entityKey,
                  tempValues,
                );
                subTransformItem[transformArrayItem] =
                  _typeof(res) === "object" ? res[transformArrayItem] : res;
              } else if (
                _typeof(transform[transformArrayItem]) === "object" &&
      ...
      var transform = function transform() {
        ...
        if (typeof transformFunction === "function") {
          transformedResult =
            transformFunction === null || transformFunction === void 0
              ? void 0
