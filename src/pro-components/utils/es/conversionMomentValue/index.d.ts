 ...
 * @returns boolean
 */
export declare function isPlainObject(o: { constructor: any }): boolean;
/**
 * 根据不同的格式转化 dayjs
 ...
 */
export declare const convertMoment: (
  value: dayjs.Dayjs,
  dateFormatter: DateFormatter,
  valueType: string,
) => string | number | dayjs.Dayjs;
/**
 ...
 */
export declare const conversionMomentValue: <T extends {} = any>(
  value: T,
  dateFormatter: DateFormatter,
  valueTypeMap: Record<
    string,
