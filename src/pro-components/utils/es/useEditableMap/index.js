...
export function useEditableMap(props) {
  ...
  var isEditable = useCallback(
    function (recordKey) {
      if (
        editableKeys !== null &&
        editableKeys !== void 0 &&
        editableKeys.includes(recordKeyToString(recordKey))
      )
        return true;
      return false;
    },
  ...
  var startEditable = function startEditable(recordKey, recordValue) {
    ...
    preEditRowRef.current =
      (_ref2 =
        recordValue !== null && recordValue !== void 0
          ? recordValue
          : get(props.dataSource, Array.isArray(recordKey) ? recordKey : [recordKey])) !== null &&
      _ref2 !== void 0
        ? _ref2
        : null;
  ...
  var onCancel = /*#__PURE__*/ (function () {
    var _ref3 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(
        function _callee(recordKey, editRow, originRow, newLine) {
          var _props$onCancel;
          var success;
  ...
  var onSave = /*#__PURE__*/ (function () {
    var _ref4 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(recordKey, editRow, originRow) {
        var _props$onSave;
            ...
            switch ((_context2.prev = _context2.next)) {
              case 0:
                ...
                return props === null ||
                  ...
                  ? void 0
                  : _props$onSave.call(props, recordKey, editRow, originRow);
              case 2:
