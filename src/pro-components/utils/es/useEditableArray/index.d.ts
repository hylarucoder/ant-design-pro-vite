 ...
 * @param action
 */
export declare function editableRowByKey<RecordType>(
  keyProps: {
    data: RecordType[];
 ...
 */
export declare function SaveEditableAction<T>(
  {
    recordKey,
    onSave,
    row,
 ...
 * @param ActionRenderConfig
 */
export declare const DeleteEditableAction: React.FC<
  ActionRenderConfig<any> & {
    row: any;
  }
>;
export declare function defaultActionRender<T>(
  row: T,
  config: ActionRenderConfig<T, NewLineConfig<T>>,
): {
 ...
 * @param props
 */
export declare function useEditableArray<RecordType extends AnyObject>(
  ...
  setEditableRowKeys: (
    updater:
      | React.Key[]
      | ((origin: React.Key[] | undefined) => React.Key[] | undefined)
      | undefined,
    ignoreDestroy?: boolean | undefined,
  ) => void;
  isEditable: (
    row: RecordType & {
      index: number;
