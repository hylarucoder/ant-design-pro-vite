...
export var isNeedOpenHash = function isNeedOpenHash() {
  ...
  if (
    ...
    (((_process$env$NODE_ENV = process.env.NODE_ENV) === null || _process$env$NODE_ENV === void 0
      ? void 0
      : _process$env$NODE_ENV.toUpperCase()) === "TEST" ||
      ((_process$env$NODE_ENV2 = process.env.NODE_ENV) === null || _process$env$NODE_ENV2 === void 0
        ? void 0
        : _process$env$NODE_ENV2.toUpperCase()) === "DEV")
  ) {
    return false;
  }
  return true;
...
var ConfigProviderContainer = function ConfigProviderContainer(props) {
    ...
    function () {
      ...
      var resolvedIntl =
        intl !== null && intl !== void 0
          ? intl
          : localeName &&
              ((_proProvide$intl = proProvide.intl) === null || _proProvide$intl === void 0
                ? void 0
                : _proProvide$intl.locale) === "default"
            ? intlMap[key]
            : proProvide.intl || intlMap[key];
      return _objectSpread(
        _objectSpread({}, proProvide),
        {},
        {
  ...
  var finalToken = _objectSpread(
    _objectSpread({}, proProvideValue.token || {}),
    {},
    {
      proComponentsCls: proComponentsCls,
    },
  ...
  var themeConfig = useMemo(
    function () {
      return _objectSpread(
        _objectSpread({}, restConfig.theme),
        {},
        {
          hashId: hashId,
  ...
  var proConfigContextValue = useMemo(
    function () {
      return _objectSpread(
        _objectSpread({}, proProvideValue),
        {},
        {
          valueTypeMap:
            valueTypeMap ||
            (proProvideValue === null || proProvideValue === void 0
              ? void 0
              : proProvideValue.valueTypeMap),
          token: token,
  ...
  var configProviderDom = useMemo(
    function () {
      return /*#__PURE__*/ _jsx(
        AntdConfigProvider,
        _objectSpread(
          _objectSpread({}, restConfig),
          {},
          {
            theme: themeConfig,
...
export var ProConfigProvider = function ProConfigProvider(props) {
  ...
  var mergeAlgorithm = function mergeAlgorithm() {
    ...
    if (isDark && Array.isArray(theme === null || theme === void 0 ? void 0 : theme.algorithm)) {
      return []
        .concat(
          _toConsumableArray((theme === null || theme === void 0 ? void 0 : theme.algorithm) || []),
          [proTheme.darkAlgorithm],
        )
        .filter(Boolean);
    }
  ...
  // 自动注入 antd 的配置
  var configProvider = _objectSpread(
    _objectSpread({}, rest),
    {},
    {
      locale: locale || zh_CN,
