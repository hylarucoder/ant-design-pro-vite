...
var FieldTimePicker = function FieldTimePicker(_ref, ref) {
  ...
  var intl = useIntl();
  var finalFormat =
    (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.format) ||
    format ||
    "HH:mm:ss";
    ...
    if (light) {
      ...
      _dom = /*#__PURE__*/ _jsx(FieldLabel, {
        onClick: function onClick() {
          ...
          fieldProps === null ||
            fieldProps === void 0 ||
            (_fieldProps$onOpenCha = fieldProps.onOpenChange) === null ||
            _fieldProps$onOpenCha === void 0 ||
            _fieldProps$onOpenCha.call(fieldProps, true);
          setOpen(true);
        },
        style: dayValue
          ? {
        ...
        value:
          dayValue || open
            ? /*#__PURE__*/ _jsx(
                ...
                _objectSpread(
                  _objectSpread(
                    _objectSpread({}, compatibleBorder(false)),
                    {},
                    {
                      format: format,
                      ref: ref,
                  ...
                  {
                    placeholder:
                      (_fieldProps$placehold = fieldProps.placeholder) !== null &&
                      _fieldProps$placehold !== void 0
                        ? _fieldProps$placehold
                    ...
                    onOpenChange: function onOpenChange(isOpen) {
                      ...
                      fieldProps === null ||
                        fieldProps === void 0 ||
                        (_fieldProps$onOpenCha2 = fieldProps.onOpenChange) === null ||
                        _fieldProps$onOpenCha2 === void 0 ||
                        _fieldProps$onOpenCha2.call(fieldProps, isOpen);
                    },
                    open: open,
                  },
                ),
  ...
  if (mode === "edit" || mode === "update") {
    ...
    if (light) {
      var disabled = fieldProps.disabled,
        ...
        placeholder =
          _fieldProps$placehold2 === void 0
            ? [
                intl.getMessage("tableForm.selectPlaceholder", "请选择"),
                intl.getMessage("tableForm.selectPlaceholder", "请选择"),
              ]
            : _fieldProps$placehold2;
      _dom2 = /*#__PURE__*/ _jsx(FieldLabel, {
        onClick: function onClick() {
          var _fieldProps$onOpenCha3;
          fieldProps === null ||
            fieldProps === void 0 ||
            (_fieldProps$onOpenCha3 = fieldProps.onOpenChange) === null ||
            _fieldProps$onOpenCha3 === void 0 ||
            _fieldProps$onOpenCha3.call(fieldProps, true);
          setOpen(true);
        },
        style: dayValue
          ? {
                ...
                _objectSpread(
                  ...
                  {},
                  {
                    ...
                    onOpenChange: function onOpenChange(isOpen) {
                      ...
                      fieldProps === null ||
                        fieldProps === void 0 ||
                        (_fieldProps$onOpenCha4 = fieldProps.onOpenChange) === null ||
                        _fieldProps$onOpenCha4 === void 0 ||
                        _fieldProps$onOpenCha4.call(fieldProps, isOpen);
                    },
                    open: open,
                  },
                ),
