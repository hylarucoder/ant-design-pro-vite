...
var FieldCascader = function FieldCascader(_ref, ref) {
  ...
  useImperativeHandle(
    ...
    function () {
      return _objectSpread(
        _objectSpread({}, cascaderRef.current || {}),
        {},
        {
  ...
  var optionsValueEnum = useMemo(
    function () {
       ...
       */
      var _ref2 =
          ((_rest$fieldProps = rest.fieldProps) === null || _rest$fieldProps === void 0
            ? void 0
            : _rest$fieldProps.fieldNames) || {},
    ...
    [
      mode,
      options,
      (_rest$fieldProps2 = rest.fieldProps) === null || _rest$fieldProps2 === void 0
        ? void 0
        : _rest$fieldProps2.fieldNames,
    ],
  );
  if (mode === "read") {
  ...
  if (mode === "edit") {
    ...
    var _dom = /*#__PURE__*/ _jsx(
      ...
      _objectSpread(
        _objectSpread(
          _objectSpread({}, compatibleBorder(!light)),
          {},
          {
            ref: cascaderRef,
            open: open,
            ...
            allowClear:
              ((_rest$fieldProps3 = rest.fieldProps) === null || _rest$fieldProps3 === void 0
                ? void 0
                : _rest$fieldProps3.allowClear) !== false,
          },
          rest.fieldProps,
        ),
        {},
        {
          onDropdownVisibleChange: function onDropdownVisibleChange(isOpen) {
            ...
            rest === null ||
              rest === void 0 ||
              (_rest$fieldProps4 = rest.fieldProps) === null ||
              _rest$fieldProps4 === void 0 ||
              (_rest$fieldProps4$onD = _rest$fieldProps4.onDropdownVisibleChange) === null ||
              _rest$fieldProps4$onD === void 0 ||
              _rest$fieldProps4$onD.call(_rest$fieldProps4, isOpen);
            setOpen(isOpen);
          },
          className: classNames(
            (_rest$fieldProps5 = rest.fieldProps) === null || _rest$fieldProps5 === void 0
              ? void 0
              : _rest$fieldProps5.className,
            layoutClassName,
          ),
          options: options,
        },
    ...
    if (renderFormItem) {
      var _renderFormItem;
      _dom =
        (_renderFormItem = renderFormItem(
          rest.text,
          _objectSpread(
            _objectSpread(
              {
    ...
    if (light) {
      ...
      return /*#__PURE__*/ _jsx(FieldLabel, {
        ...
        onClick: function onClick() {
          ...
          rest === null ||
            rest === void 0 ||
            (_rest$fieldProps7 = rest.fieldProps) === null ||
            _rest$fieldProps7 === void 0 ||
            (_rest$fieldProps7$onD = _rest$fieldProps7.onDropdownVisibleChange) === null ||
            _rest$fieldProps7$onD === void 0 ||
            _rest$fieldProps7$onD.call(_rest$fieldProps7, true);
        },
      });
    }
    return _dom;
