...
var FieldRangePicker = function FieldRangePicker(_ref, ref) {
  ...
  var genFormatText = useCallback(
    function (formatValue) {
      if (
        typeof (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.format) ===
        "function"
      ) {
        var _fieldProps$format;
        return fieldProps === null ||
          fieldProps === void 0 ||
          (_fieldProps$format = fieldProps.format) === null ||
          _fieldProps$format === void 0
          ? void 0
          : _fieldProps$format.call(fieldProps, formatValue);
      }
      return (
  ...
  if (mode === "edit" || mode === "update") {
    ...
    var handleRangeChange = function handleRangeChange(value) {
      ...
      fieldProps === null ||
        ...
        _fieldProps$onChange.call(fieldProps, value);
      if (!value) {
        setOpen(false);
      }
    };
