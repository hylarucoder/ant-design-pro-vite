...
var FieldRadio = function FieldRadio(_ref, ref) {
  ...
  var radioRef = useRef();
  var status =
    (_Form$Item = Form.Item) === null ||
    _Form$Item === void 0 ||
    (_Form$Item$useStatus = _Form$Item.useStatus) === null ||
    _Form$Item$useStatus === void 0
      ? void 0
      : _Form$Item$useStatus.call(_Form$Item);
  useImperativeHandle(
    ref,
    function () {
      return _objectSpread(
        _objectSpread({}, radioRef.current || {}),
        {},
        {
  ...
  var _useStyle = useStyle("FieldRadioRadio", function (token) {
      return _defineProperty(
        _defineProperty(
          _defineProperty({}, ".".concat(layoutClassName, "-error"), {
            span: {
        ...
        ".".concat(layoutClassName, "-vertical"),
        _defineProperty({}, "".concat(token.antCls, "-radio-wrapper"), {
          display: "flex",
          marginInlineEnd: 0,
        }),
      );
  ...
  if (mode === "read") {
    var optionsValueEnum =
      options !== null && options !== void 0 && options.length
        ? options === null || options === void 0
          ? void 0
          : options.reduce(function (pre, cur) {
              var _ref3;
              return _objectSpread(
                _objectSpread({}, pre),
                {},
                _defineProperty(
                  {},
                  (_ref3 = cur.value) !== null && _ref3 !== void 0 ? _ref3 : "",
                  cur.label,
                ),
              );
            }, {})
          ...
          {},
          {
            className: classNames(
              (_rest$fieldProps = rest.fieldProps) === null || _rest$fieldProps === void 0
                ? void 0
                : _rest$fieldProps.className,
              _defineProperty(
                _defineProperty(
                  {},
                  "".concat(layoutClassName, "-error"),
                  (status === null || status === void 0 ? void 0 : status.status) === "error",
                ),
                "".concat(layoutClassName, "-warning"),
                (status === null || status === void 0 ? void 0 : status.status) === "warning",
              ),
              hashId,
              "".concat(layoutClassName, "-").concat(rest.fieldProps.layout || "horizontal"),
            ),
            options: options,
          },
        ),
