...
var SearchSelect = function SearchSelect(props, ref) {
  ...
  var _useState = useState(
      propsSearchValue !== null && propsSearchValue !== void 0
        ? propsSearchValue
        : defaultSearchValue,
    ),
  ...
  useEffect(
    function () {
      if (restProps.autoFocus) {
        ...
        selectRef === null ||
          selectRef === void 0 ||
          (_selectRef$current = selectRef.current) === null ||
          _selectRef$current === void 0 ||
          _selectRef$current.focus();
      }
    },
    [restProps.autoFocus],
  );
  ...
  var getMergeValue = function getMergeValue(value, option) {
    if (Array.isArray(value) && Array.isArray(option) && value.length > 0) {
      ...
      return value.map(function (item, index) {
        ...
        var dataItem =
          optionItem === null || optionItem === void 0 ? void 0 : optionItem["data-item"];
        return _objectSpread(
          _objectSpread(_objectSpread({}, dataItem || {}), item),
          {},
          {
  ...
  var genOptions = function genOptions(mapOptions) {
    return mapOptions.map(function (item, index) {
      ...
      var itemOptions =
        (_item$optionsPropsNam = item[optionsPropsName]) !== null &&
        _item$optionsPropsNam !== void 0
          ? _item$optionsPropsNam
          : [];
          ...
          {},
          {
            ...
            key:
              value !== null && value !== void 0
                ? value
                : ""
                    .concat(label === null || label === void 0 ? void 0 : label.toString(), "-")
                    .concat(index, "-")
                    .concat(nanoid()),
            // 防止因key相同导致虚拟滚动出问题
      ...
      return _objectSpread(
        ...
        {},
        {
          ...
          "data-item": item,
          className: ""
            .concat(prefixCls, "-option ")
            .concat(itemClassName || "")
            .trim(),
          label:
            (optionItemRender === null || optionItemRender === void 0
              ? void 0
              : optionItemRender(item)) || label,
        },
      );
    });
  };
      ...
      {},
      {
          ...
          restProps.filterOption == false
            ...
            : function (inputValue, option) {
                ...
                return !!(
                  (option !== null &&
                    option !== void 0 &&
                    (_option$data_title = option.data_title) !== null &&
                    _option$data_title !== void 0 &&
                    _option$data_title
                      .toString()
                      .toLowerCase()
                  ...
                  (option !== null &&
                    option !== void 0 &&
                    (_option$optionFilterP = option[optionFilterProp]) !== null &&
                    _option$optionFilterP !== void 0 &&
                    _option$optionFilterP
                      .toString()
                      .toLowerCase()
                      .includes(inputValue.toLowerCase()))
                );
        ...
        onChange: function onChange(value, optionList) {
          ...
          if (!props.labelInValue) {
            _onChange === null ||
              _onChange === void 0 ||
              _onChange.apply(void 0, [value, optionList].concat(rest));
            return;
          }
          if (mode !== "multiple" && !Array.isArray(optionList)) {
            ...
            if (!value || !dataItem) {
                    ...
                    {},
                    {
                      ...
                      label:
                        preserveOriginalLabel && dataItem
                          ? (dataItem === null || dataItem === void 0 ? void 0 : dataItem.label) ||
                            value.label
                          : value.label,
                    },
                  )
              ...
              _onChange === null ||
                _onChange === void 0 ||
                _onChange.apply(void 0, [changedValue, optionList].concat(rest));
            } else {
              _onChange === null ||
                _onChange === void 0 ||
                _onChange.apply(
                  ...
                  [
                    _objectSpread(
                      _objectSpread(_objectSpread({}, value), dataItem),
                      {},
                      {
          ...
          _onChange === null ||
            _onChange === void 0 ||
            _onChange.apply(void 0, [mergeValue, optionList].concat(rest));
