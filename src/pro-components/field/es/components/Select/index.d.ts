 ...
 * @param valueEnum
 */
export declare const proFieldParsingValueEnumToArray: (
  valueEnumParams: ProFieldValueEnumType,
) => SelectOptionType;
export declare const useFieldFetchData: (
...
declare const _default: React.ForwardRefExoticComponent<
  import("@ant-design/pro-provider").BaseProFieldFC &
    import("@ant-design/pro-provider").ProRenderFieldPropsType & {
      text: string;
      /** 值的枚举，如果存在枚举，Search 中会生成 select */
    ...
    Pick<
      SelectProps<any, import("antd/es/select").DefaultOptionType>,
      "style" | "className" | "fieldNames"
    > &
