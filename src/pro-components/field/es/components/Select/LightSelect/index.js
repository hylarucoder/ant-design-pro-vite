...
var LightSelect = function LightSelect(props, ref) {
  ...
  var _useStyle = useStyle("LightSelect", function (token) {
      return _defineProperty(
        ...
        ".".concat(prefixCls),
        _defineProperty(
          _defineProperty({}, "".concat(token.antCls, "-select"), {
            position: "absolute",
            width: "153px",
            height: "28px",
            visibility: "hidden",
  ...
  return wrapSSR(
    /*#__PURE__*/ _jsxs("div", {
      className: classNames(
        prefixCls,
        hashId,
        _defineProperty({}, "".concat(prefixCls, "-searchable"), showSearch),
        "".concat(prefixCls, "-container-").concat(restProps.placement || "bottomLeft"),
        className,
      ),
      style: style,
      onClick: function onClick(e) {
        ...
        var isLabelClick =
          lightLabel === null ||
          lightLabel === void 0 ||
          (_lightLabel$current = lightLabel.current) === null ||
          _lightLabel$current === void 0 ||
          (_lightLabel$current = _lightLabel$current.labelRef) === null ||
          _lightLabel$current === void 0 ||
          (_lightLabel$current = _lightLabel$current.current) === null ||
          _lightLabel$current === void 0
            ? void 0
            : _lightLabel$current.contains(e.target);
        if (isLabelClick) {
          setOpen(!open);
        } else {
          // 这里注释掉
      ...
      children: [
          ...
          _objectSpread(
            ...
            {},
            {
              ...
              onDropdownVisibleChange: function onDropdownVisibleChange(isOpen) {
                ...
                restProps === null ||
                  restProps === void 0 ||
                  (_restProps$onDropdown = restProps.onDropdownVisibleChange) === null ||
                  _restProps$onDropdown === void 0 ||
                  _restProps$onDropdown.call(restProps, isOpen);
              },
                ...
                onSearch || !keyword
                  ...
                  : options === null || options === void 0
                    ...
                    : options.filter(function (o) {
                        ...
                        return (
                          ((_String = String(o[labelPropsName])) === null ||
                          _String === void 0 ||
                          (_String = _String.toLowerCase()) === null ||
                          _String === void 0
                            ? void 0
                            : _String.includes(
                          ...
                          ((_o$valuePropsName = o[valuePropsName]) === null ||
                          _o$valuePropsName === void 0 ||
                          (_o$valuePropsName = _o$valuePropsName.toString()) === null ||
                          _o$valuePropsName === void 0 ||
                          (_o$valuePropsName = _o$valuePropsName.toLowerCase()) === null ||
                          _o$valuePropsName === void 0
                            ? void 0
                            : _o$valuePropsName.includes(
                                keyword === null || keyword === void 0
                                  ? void 0
                                  : keyword.toLowerCase(),
                              ))
        ...
        /*#__PURE__*/ _jsx(FieldLabel, {
          ...
          allowClear: !!allowClear,
          value:
            filterValue || (value === null || value === void 0 ? void 0 : value.label) || value,
