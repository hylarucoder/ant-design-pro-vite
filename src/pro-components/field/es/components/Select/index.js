...
var Highlight = function Highlight(_ref) {
  ...
  var _useStyle = useStyle("Highlight", function (token) {
      return _defineProperty(
        _defineProperty({}, ".".concat(lightCls), {
  ...
  var matchKeywordsRE = new RegExp(
    words
      .map(function (word) {
...
function filerByItem(item, keyWords) {
  ...
  if (
    (item !== null &&
      item !== void 0 &&
      (_item$label = item.label) !== null &&
      _item$label !== void 0 &&
      _item$label.toString().toLowerCase().includes(keyWords.toLowerCase())) ||
    (item !== null &&
      item !== void 0 &&
      (_item$value = item.value) !== null &&
      _item$value !== void 0 &&
      _item$value.toString().toLowerCase().includes(keyWords.toLowerCase()))
  ) {
    return true;
  }
  if (item.children || item.options) {
    var findItem = []
      .concat(_toConsumableArray(item.children || []), [item.options || []])
      .find(function (mapItem) {
...
export var useFieldFetchData = function useFieldFetchData(props) {
  ...
  var defaultOptions = useDeepCompareMemo(
    function () {
      if (!fieldProps) return undefined;
      var data =
        (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.options) ||
        (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.treeData);
  ...
  useDeepCompareEffect(
    function () {
      ...
      if (
        !props.valueEnum ||
        ((_props$fieldProps = props.fieldProps) !== null &&
          _props$fieldProps !== void 0 &&
          _props$fieldProps.options) ||
        ((_props$fieldProps2 = props.fieldProps) !== null &&
          _props$fieldProps2 !== void 0 &&
          _props$fieldProps2.treeData)
      )
        return;
  ...
  var swrKey = useDebounceValue(
    [proFieldKeyRef.current, props.params, keyWords],
    (_ref5 =
      (_props$debounceTime = props.debounceTime) !== null && _props$debounceTime !== void 0
        ? _props$debounceTime
        : props === null ||
            props === void 0 ||
            (_props$fieldProps3 = props.fieldProps) === null ||
            _props$fieldProps3 === void 0
          ? void 0
          : _props$fieldProps3.debounceTime) !== null && _ref5 !== void 0
      ? _ref5
      : 0,
  ...
  var resOptions = useMemo(
    function () {
        ...
        options === null || options === void 0
          ...
          : options.map(function (item) {
              ...
              if (item.children || item.options) {
                var childrenOptions = []
                  .concat(
                    _toConsumableArray(item.children || []),
                    _toConsumableArray(item.options || []),
                  )
      ...
      if (
        ((_props$fieldProps4 = props.fieldProps) === null || _props$fieldProps4 === void 0
          ? void 0
          : _props$fieldProps4.filterOption) === true ||
        ((_props$fieldProps5 = props.fieldProps) === null || _props$fieldProps5 === void 0
          ? void 0
          : _props$fieldProps5.filterOption) === undefined
      ) {
    ...
    [
      options,
      keyWords,
      (_props$fieldProps6 = props.fieldProps) === null || _props$fieldProps6 === void 0
        ? void 0
        : _props$fieldProps6.filterOption,
    ],
  );
...
var FieldSelect = function FieldSelect(props, ref) {
  ...
  useImperativeHandle(
    ...
    function () {
      return _objectSpread(
        _objectSpread({}, inputRef.current || {}),
        {},
        {
  ...
  var optionsValueEnum = useMemo(
    function () {
       ...
       */
      var _ref9 =
          (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.fieldNames) || {},
  ...
  if (mode === "edit" || mode === "update") {
    var renderDom = function renderDom() {
      if (light) {
        return /*#__PURE__*/ _jsx(
          LightSelect,
          _objectSpread(
            _objectSpread({}, compatibleBorder(bordered)),
            {},
            {
              id: id,
              loading: loading,
    ...
    if (renderFormItem) {
      var _renderFormItem;
      return (_renderFormItem = renderFormItem(
        rest.text,
        _objectSpread(
          _objectSpread(
            {
