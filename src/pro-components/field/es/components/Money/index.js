...
var getTextByLocale = function getTextByLocale(locale, paramsText, precision, config) {
  ...
  var moneyText =
    paramsText === null || paramsText === void 0
      ? void 0
      : paramsText.toString().replaceAll(",", "");
  ...
  try {
    ...
    var initNumberFormatter = new Intl.NumberFormat(
      supportFormat && locale !== false
        ? (locale === null || locale === void 0 ? void 0 : locale.replace("_", "-")) || "zh-Hans-CN"
        : "zh-Hans-CN",
      _objectSpread(
        _objectSpread({}, intlMap[locale || "zh-Hans-CN"] || defaultMoneyIntl),
        {},
        {
    ...
    _objectSpread(
      ...
      {},
      {
        ...
        getPopupContainer: function getPopupContainer(triggerNode) {
          return (
            (triggerNode === null || triggerNode === void 0 ? void 0 : triggerNode.parentElement) ||
            document.body
          );
        },
...
var FieldMoney = function FieldMoney(_ref4, ref) {
  ...
  var text = _ref4.text,
    ...
    numberFormatOptions =
      _ref4$numberFormatOpt === void 0
        ? fieldProps === null || fieldProps === void 0
          ? void 0
          : fieldProps.numberFormatOptions
        : _ref4$numberFormatOpt,
    _ref4$numberPopoverRe = _ref4.numberPopoverRender,
    numberPopoverRender =
      _ref4$numberPopoverRe === void 0
        ? (fieldProps === null || fieldProps === void 0
            ? void 0
            : fieldProps.numberPopoverRender) || false
        : _ref4$numberPopoverRe,
    rest = _objectWithoutProperties(_ref4, _excluded2);
  var precision =
    (_fieldProps$precision =
      fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.precision) !== null &&
    _fieldProps$precision !== void 0
      ? _fieldProps$precision
      : DefaultPrecisionCont;
  var intl = useIntl();
   ...
   * 1000 -> 1,000
   */
  var getFormateValue = useCallback(
    function (value) {
      // 新建数字正则，需要配置小数点
      var reg = new RegExp(
        "\\B(?=(\\d{".concat(3 + Math.max(precision - DefaultPrecisionCont, 0), "})+(?!\\d))"),
        "g",
      );
      // 切分为 整数 和 小数 不同
      ...
      if (floatStr && precision > 0) {
        resultFloat = ".".concat(
          floatStr.slice(0, precision === undefined ? DefaultPrecisionCont : precision),
        );
      }
  ...
  if (type === "read") {
    var dom = /*#__PURE__*/ _jsx("span", {
      ref: ref,
      children: getTextByLocale(
        locale || false,
        text,
        precision,
        numberFormatOptions !== null && numberFormatOptions !== void 0
          ? numberFormatOptions
          : fieldProps.numberFormatOptions,
        moneySymbol,
      ),
        ...
        _objectSpread(
          {
            contentRender: function contentRender(props) {
              ...
              var localeText = getTextByLocale(
                moneySymbol || locale || false,
                "".concat(getFormateValue(props.value)),
                precision,
                _objectSpread(
                  _objectSpread({}, numberFormatOptions),
                  {},
                  {
                    notation: "compact",
                  },
              ...
              if (typeof numberPopoverRender === "function") {
                return numberPopoverRender === null || numberPopoverRender === void 0
                  ? void 0
                  : numberPopoverRender(props, localeText);
              }
              return localeText;
            },
            ref: ref,
        ...
        {},
        {
          onBlur: fieldProps.onBlur
            ? function (e) {
                ...
                (_fieldProps$onBlur = fieldProps.onBlur) === null ||
                  _fieldProps$onBlur === void 0 ||
                  _fieldProps$onBlur.call(fieldProps, value);
              }
            : undefined,
        },
      ),
