...
var FieldDigit = function FieldDigit(_ref, ref) {
  ...
  if (type === "read") {
    ...
    var digit = new Intl.NumberFormat(
      undefined,
      _objectSpread(
        _objectSpread({}, fractionDigits),
        (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.intlProps) || {},
      ),
    ).format(Number(text));

    // 如果是 string 模式，什么都不要处理了
    var dom = !(fieldProps !== null && fieldProps !== void 0 && fieldProps.stringMode)
      ? /*#__PURE__*/ _jsx("span", {
          ref: ref,
          children:
            (fieldProps === null ||
            fieldProps === void 0 ||
            (_fieldProps$formatter = fieldProps.formatter) === null ||
            _fieldProps$formatter === void 0
              ? void 0
              : _fieldProps$formatter.call(fieldProps, digit)) || digit,
        })
      : /*#__PURE__*/ _jsx("span", {
          children: text,
        });
        ...
        {},
        {
          onChange: function onChange(e) {
            ...
            return fieldProps === null ||
              ...
              ? void 0
              : _fieldProps$onChange.call(fieldProps, proxyChange(e));
          },
          onBlur: function onBlur(e) {
            ...
            return fieldProps === null ||
              ...
              ? void 0
              : _fieldProps$onBlur.call(fieldProps, proxyChange(e.target.value));
          },
        },
      ),
    );
