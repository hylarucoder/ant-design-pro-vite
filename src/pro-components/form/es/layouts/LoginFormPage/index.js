...
export function LoginFormPage(props) {
  ...
  var genSubmitButtonProps = function genSubmitButtonProps() {
    ...
    if (
      ((_proFormProps$submitt = proFormProps.submitter) === null || _proFormProps$submitt === void 0
        ? void 0
        : _proFormProps$submitt.submitButtonProps) === false
    )
      return false;
    return _objectSpread(
      ...
      (_proFormProps$submitt2 = proFormProps.submitter) === null ||
        ...
        ? void 0
        : _proFormProps$submitt2.submitButtonProps,
    );
  };
