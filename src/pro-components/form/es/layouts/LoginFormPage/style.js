  ...
  return _defineProperty(
    _defineProperty(
      _defineProperty(
        ...
        "@media (max-width: ".concat(token.screenMDMin, "px)"),
        _defineProperty({}, token.componentCls, {
      ...
      "@media (min-width: ".concat(token.screenMDMin, "px)"),
      _defineProperty({}, token.componentCls, {
        "&-left": {
          backgroundRepeat: "no-repeat",
    ...
    "@media (max-width: ".concat(token.screenSM, "px)"),
    _defineProperty({}, token.componentCls, {
      "&-main": {
        width: "95%",
        maxWidth: "328px",
...
export function useStyle(prefixCls) {
  return useAntdStyle("LoginFormPage", function (token) {
    var loginFormToken = _objectSpread(
      _objectSpread({}, token),
      {},
      {
