...
var getSpanConfig = function getSpanConfig(layout, width, span) {
  ...
  var spanConfig = span
    ? ["xs", "sm", "md", "lg", "xl", "xxl"].map(function (key) {
  ...
  return items === null || items === void 0
    ...
    : items.flatMap(function (item) {
        ...
        if (
          ...
          _item$type === void 0
            ? void 0
            : _item$type.displayName) === "ProForm-Group" &&
          !((_item$props = item.props) !== null && _item$props !== void 0 && _item$props.title)
        ) {
...
var QueryFilterContent = function QueryFilterContent(props) {
  var _props$submitterColSp5,
    _props$submitterColSp6,
    _props$submitterColSp7,
    _props$submitterColSp8;
  var intl = useIntl();
  ...
  var processedList = flatMapItems(items, props.ignoreRules).map(function (item, index) {
    ...
    var colSize = /*#__PURE__*/ React.isValidElement(item)
      ? (_item$props$colSize =
          item === null ||
          item === void 0 ||
          (_item$props3 = item.props) === null ||
          _item$props3 === void 0
            ? void 0
            : _item$props3.colSize) !== null && _item$props$colSize !== void 0
        ? _item$props$colSize
        : 1
      : 1;
    ...
    if (index === 0) {
      ...
      firstRowFull =
        ...
        !(
          item !== null &&
          item !== void 0 &&
          (_props = item.props) !== null &&
          _props !== void 0 &&
          _props.hidden
        );
    }
    var hidden =
      (item === null || item === void 0 || (_props2 = item.props) === null || _props2 === void 0
        ? void 0
        : _props2.hidden) ||
      // 如果收起了
      (collapsed &&
  ...
  var doms = processedList.map(function (itemProps, index) {
    ...
    // 每一列的key, 一般是存在的
    var itemKey =
      /*#__PURE__*/ (React.isValidElement(itemDom) &&
        (itemDom.key ||
          "".concat(
            (_itemDom$props = itemDom.props) === null || _itemDom$props === void 0
              ? void 0
              : _itemDom$props.name,
          ))) ||
      index;
    ...
    if (split && currentSpan % 24 === 0 && index < itemLength - 1) {
      return /*#__PURE__*/ _jsx(
        Col,
        {
          span: colSpan,
          className: ""
            .concat(props.baseClassName, "-row-split-line ")
            .concat(props.baseClassName, "-row-split ")
            .concat(hashId)
            .trim(),
          children: itemDom,
        },
  ...
  var hiddenNum =
    showHiddenNum &&
    processedList.filter(function (item) {
      return item.hidden;
    }).length;

  /** 是否需要展示 collapseRender */
  var needCollapseRender = useMemo(
    function () {
  ...
  var offset = useMemo(
    function () {
      ...
      var offsetSpan =
        (currentSpan % 24) +
        ((_props$submitterColSp =
          (_props$submitterColSp2 = props.submitterColSpanProps) === null ||
          _props$submitterColSp2 === void 0
            ? void 0
            : _props$submitterColSp2.span) !== null && _props$submitterColSp !== void 0
          ? _props$submitterColSp
          : spanSize.span);
      if (offsetSpan > 24) {
        ...
        return (
          24 -
          ((_props$submitterColSp3 =
            (_props$submitterColSp4 = props.submitterColSpanProps) === null ||
            _props$submitterColSp4 === void 0
              ? void 0
              : _props$submitterColSp4.span) !== null && _props$submitterColSp3 !== void 0
            ? _props$submitterColSp3
            : spanSize.span)
        );
      }
    ...
    [
      currentSpan,
      (currentSpan % 24) +
        ((_props$submitterColSp5 =
          (_props$submitterColSp6 = props.submitterColSpanProps) === null ||
          _props$submitterColSp6 === void 0
            ? void 0
            : _props$submitterColSp6.span) !== null && _props$submitterColSp5 !== void 0
          ? _props$submitterColSp5
          : spanSize.span),
      (_props$submitterColSp7 = props.submitterColSpanProps) === null ||
      _props$submitterColSp7 === void 0
        ? void 0
        : _props$submitterColSp7.span,
    ],
  );
              ...
              _objectSpread(
                {
                  ...
                  className: classNames(
                    (_props$submitterColSp8 = props.submitterColSpanProps) === null ||
                      _props$submitterColSp8 === void 0
                      ? void 0
                      : _props$submitterColSp8.className,
                  ),
                },
...
var defaultWidth = isBrowser()
  ? (_document = document) === null ||
    _document === void 0 ||
    (_document = _document.body) === null ||
    _document === void 0
    ? void 0
    : _document.clientWidth
  : 1024;
function QueryFilter(props) {
  ...
  var _useMountMergeState = useMountMergeState(function () {
      return typeof (style === null || style === void 0 ? void 0 : style.width) === "number"
  ...
  var spanSize = useMemo(
    function () {
      return getSpanConfig(layout, width + 16, span);
    },
    [layout, width, span],
  );
  var showLength = useMemo(
    function () {
