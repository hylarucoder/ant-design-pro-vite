...
function StepsForm(props) {
  ...
  var layoutRender = useMemo(
    function () {
      return StepsLayoutStrategy[
  ...
  useImperativeHandle(
    ...
    function () {
      ...
      return (_formArrayRef$current = formArrayRef.current[step || 0]) === null ||
        _formArrayRef$current === void 0
        ? void 0
        : _formArrayRef$current.current;
    },
   ...
   */
  var onFormFinish = useCallback(
    /*#__PURE__*/ (function () {
      var _ref3 = _asyncToGenerator(
        /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(name, formData) {
          var values, success;
              ...
              while (1)
                switch ((_context.prev = _context.next)) {
                  ...
                  case 3:
                    ...
                    values = merge.apply(
                      void 0,
                      [{}].concat(_toConsumableArray(Array.from(formDataRef.current.values()))),
                    );
                    _context.prev = 5;
                    _context.next = 8;
                  ...
                  case 8:
                    ...
                    if (success) {
                      ...
                      formArrayRef.current.forEach(function (form) {
                        var _form$current;
                        return (_form$current = form.current) === null || _form$current === void 0
                          ? void 0
    ...
    function () {
      ...
      return /*#__PURE__*/ _jsx("div", {
        ...
        children: /*#__PURE__*/ _jsx(
          Steps,
          _objectSpread(
            _objectSpread(_objectSpread({}, stepsProps), itemsProps),
            {},
            {
              current: step,
              onChange: undefined,
                ...
                formArray.map(function (item) {
                  ...
                  return /*#__PURE__*/ _jsx(
                    ...
                    _objectSpread(
                      {
                        title:
                          itemProps === null || itemProps === void 0 ? void 0 : itemProps.title,
                      },
                      itemProps === null || itemProps === void 0 ? void 0 : itemProps.stepProps,
                    ),
                    item,
          ...
          _objectSpread(
            ...
            {},
            {
              onClick: function onClick() {
                ...
                submitter === null ||
                  submitter === void 0 ||
                  (_submitter$onSubmit = submitter.onSubmit) === null ||
                  _submitter$onSubmit === void 0 ||
                  _submitter$onSubmit.call(submitter);
                onSubmit();
              },
          ...
          _objectSpread(
            ...
            {},
            {
              onClick: function onClick() {
                ...
                submitter === null ||
                  submitter === void 0 ||
                  (_submitter$onReset = submitter.onReset) === null ||
                  _submitter$onReset === void 0 ||
                  _submitter$onReset.call(submitter);
              },
          ...
          _objectSpread(
            ...
            {},
            {
              onClick: function onClick() {
                ...
                submitter === null ||
                  submitter === void 0 ||
                  (_submitter$onSubmit2 = submitter.onSubmit) === null ||
                  _submitter$onSubmit2 === void 0 ||
                  _submitter$onSubmit2.call(submitter);
                onSubmit();
              },
  ...
  var submitterDom = useMemo(
    function () {
      ...
      if (submitter && submitter.render) {
        ...
        var submitterProps = {
          form:
            (_formArrayRef$current2 = formArrayRef.current[step]) === null ||
            _formArrayRef$current2 === void 0
              ? void 0
              : _formArrayRef$current2.current,
          onSubmit: onSubmit,
          step: step,
          onPre: prePage,
        };
      ...
      if (
        submitter &&
        (submitter === null || submitter === void 0 ? void 0 : submitter.render) === false
      ) {
        return null;
      }
      return buttons;
        ...
        return /*#__PURE__*/ _jsx(
          "div",
          {
            className: classNames(
              ...
              hashId,
              _defineProperty({}, "".concat(prefixCls, "-step-active"), isShow),
            ),
            children: /*#__PURE__*/ _jsx(StepFormProvide.Provider, {
              value: _objectSpread(
                _objectSpread(_objectSpread(_objectSpread({}, config), formProps), itemProps),
                {},
                {
                  name: name,
                  step: index,
        ...
        return stepsRender(
          formArray.map(function (item) {
            ...
            return {
              key: item,
              title:
                (_formMapRef$current$g = formMapRef.current.get(item)) === null ||
                _formMapRef$current$g === void 0
                  ? void 0
                  : _formMapRef$current$g.title,
            };
          }),
          stepsDom,
        );
