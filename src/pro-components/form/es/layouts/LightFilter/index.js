  ...
  return wrapSSR(
    /*#__PURE__*/ _jsx("div", {
      className: classNames(
        ...
        hashId,
        "".concat(lightFilterClassName, "-").concat(size),
        _defineProperty(
          {},
          "".concat(lightFilterClassName, "-effective"),
      ...
      children: /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
          outsideItems.map(function (child, index) {
            ...
            var newPlacement =
              fieldProps !== null && fieldProps !== void 0 && fieldProps.placement
              ...
              "div",
              {
                ...
                children: /*#__PURE__*/ React.cloneElement(child, {
                  fieldProps: _objectSpread(
                    _objectSpread({}, child.props.fieldProps),
                    {},
                    {
                  ...
                  proFieldProps: _objectSpread(
                    _objectSpread({}, child.props.proFieldProps),
                    {},
                    {
                      light: true,
                  ...
                  children: /*#__PURE__*/ _jsx(FilterDropdown, {
                    ...
                    children: collapseItems.map(function (child) {
                      ...
                      var newFieldProps = _objectSpread(
                        ...
                        {},
                        {
                          onChange: function onChange(e) {
                            setMoreValues(
                              _objectSpread(
                                _objectSpread({}, moreValues),
                                {},
                                _defineProperty(
                                  {},
                                  name,
                                  e !== null && e !== void 0 && e.target ? e.target.value : e,
                                ),
                              ),
                            );
                            return false;
                      ...
                      return /*#__PURE__*/ _jsx(
                        ...
                        {
                          className: ""
                            .concat(lightFilterClassName, "-line ")
                            .concat(hashId)
                            .trim(),
                          children: /*#__PURE__*/ React.cloneElement(child, {
                            fieldProps: _objectSpread(
                              _objectSpread({}, newFieldProps),
                              {},
                              {
                                placement: newPlacement,
                              },
          ...
          contentRender: function contentRender(items) {
            return /*#__PURE__*/ _jsx(LightFilterContainer, {
              ...
              onValuesChange: function onValuesChange(newValues) {
                ...
                (_formRef$current = formRef.current) === null ||
                  _formRef$current === void 0 ||
                  _formRef$current.setFieldsValue(newAllValues);
                (_formRef$current2 = formRef.current) === null ||
                  _formRef$current2 === void 0 ||
                  _formRef$current2.submit();
                if (_onValuesChange) {
