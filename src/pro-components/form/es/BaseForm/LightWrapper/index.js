...
var LightWrapper = function LightWrapper(props) {
  ...
  var onChange = function onChange() {
    ...
    otherFieldProps === null ||
      otherFieldProps === void 0 ||
      (_otherFieldProps$onCh = otherFieldProps.onChange) === null ||
      _otherFieldProps$onCh === void 0 ||
      _otherFieldProps$onCh.call.apply(_otherFieldProps$onCh, [otherFieldProps].concat(restParams));
  ...
  var labelValueText = useMemo(
    function () {
      ...
      if (
        valueType !== null &&
        valueType !== void 0 &&
        (_valueType$toLowerCas = valueType.toLowerCase()) !== null &&
        _valueType$toLowerCas !== void 0 &&
        _valueType$toLowerCas.endsWith("range") &&
      ...
      if (Array.isArray(labelValue))
        return labelValue.map(function (item) {
      ...
      children: /*#__PURE__*/ _jsx("div", {
        ...
        children: /*#__PURE__*/ React.cloneElement(
          ...
          _objectSpread(
            ...
            {},
            _defineProperty(
              _defineProperty({}, valuePropName, tempValue),
              "onChange",
              function onChange(e) {
