...
function BaseFormComponents(props) {
    ...
    function () {
      return {
        ...
        getFieldsFormatValue: function getFieldsFormatValue(allData) {
          ...
          return transformKey(
            (_getFormInstance = getFormInstance()) === null || _getFormInstance === void 0
              ? void 0
              : _getFormInstance.getFieldsValue(allData),
            omitNil,
          );
        },
        /**
        ...
        getFieldFormatValue: function getFieldFormatValue() {
          ...
          var value =
            (_getFormInstance2 = getFormInstance()) === null || _getFormInstance2 === void 0
              ? void 0
              : _getFormInstance2.getFieldValue(nameList);
        ...
        getFieldFormatValueObject: function getFieldFormatValueObject(paramsNameList) {
          ...
          var nameList = covertFormName(paramsNameList);
          var value =
            (_getFormInstance3 = getFormInstance()) === null || _getFormInstance3 === void 0
              ? void 0
              : _getFormInstance3.getFieldValue(nameList);
          var obj = nameList ? set({}, nameList, value) : value;
       ...
       */
        validateFieldsReturnFormatValue: (function () {
          var _validateFieldsReturnFormatValue = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(nameList) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1)
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 2:
                      _context.next = 4;
                      return (_getFormInstance4 = getFormInstance()) === null ||
                        _getFormInstance4 === void 0
                        ? void 0
                        : _getFormInstance4.validateFields(nameList);
                    case 4:
  ...
  /** 渲染提交按钮与重置按钮 */
  var submitterNode = useMemo(
    function () {
      if (submitter === false) return undefined;
      return /*#__PURE__*/ _jsx(
        Submitter,
        _objectSpread(
          _objectSpread({}, submitterProps),
          {},
          {
            onReset: function onReset() {
              var _formRef$current, _submitterProps$onRes;
              var finalValues = transformKey(
                (_formRef$current = formRef.current) === null || _formRef$current === void 0
                  ? void 0
                  : _formRef$current.getFieldsValue(),
                omitNil,
              );
              submitterProps === null ||
                submitterProps === void 0 ||
                (_submitterProps$onRes = submitterProps.onReset) === null ||
                _submitterProps$onRes === void 0 ||
                _submitterProps$onRes.call(submitterProps, finalValues);
              ...
              if (syncToUrl) {
                ...
                var params = Object.keys(
                  transformKey(
                    (_formRef$current2 = formRef.current) === null || _formRef$current2 === void 0
                      ? void 0
                      : _formRef$current2.getFieldsValue(),
                    false,
                  ),
                  ...
                  return _objectSpread(
                    _objectSpread({}, pre),
                    {},
                    _defineProperty({}, next, finalValues[next] || undefined),
                  );
                }, extraUrlParams);
  ...
  useEffect(function () {
    ...
    var finalValues = transformKey(
      (_formRef$current3 = formRef.current) === null ||
        ...
        (_formRef$current3$get = _formRef$current3.getFieldsValue) === null ||
        _formRef$current3$get === void 0
        ? void 0
        : _formRef$current3$get.call(_formRef$current3, true),
      omitNil,
    );
    onInit === null ||
      onInit === void 0 ||
      onInit(finalValues, _objectSpread(_objectSpread({}, formRef.current), formatValues));
  }, []);
  return /*#__PURE__*/ _jsx(ProFormContext.Provider, {
    value: _objectSpread(
      _objectSpread({}, formatValues),
      {},
      {
        formRef: formRef,
      },
...
function BaseForm(props) {
  ...
  var _useStyle = useStyle("ProForm", function (token) {
      return _defineProperty(
        {},
        ".".concat(prefixCls),
        _defineProperty({}, "> div:not(".concat(token.proComponentsCls, "-form-light-filter)"), {
          ".pro-field": {
            maxWidth: "100%",
  ...
  var onFinish = useRefFunction(
    /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2() {
        var _formRef$current4,
          _formRef$current4$get,
          finalValues,
          response,
          _formRef$current5,
          _formRef$current5$get,
          syncToUrlParams;
              ...
              switch ((_context2.prev = _context2.next)) {
                ...
                case 4:
                  ...
                  finalValues =
                    formRef === null ||
                    formRef === void 0 ||
                    (_formRef$current4 = formRef.current) === null ||
                    _formRef$current4 === void 0 ||
                    (_formRef$current4$get = _formRef$current4.getFieldsFormatValue) === null ||
                    _formRef$current4$get === void 0
                      ? void 0
                      : _formRef$current4$get.call(_formRef$current4);
                ...
                case 10:
                  if (syncToUrl) {
                    // 把没有的值设置为未定义可以删掉 url 的参数
                    syncToUrlParams = Object.keys(
                      formRef === null ||
                        formRef === void 0 ||
                        (_formRef$current5 = formRef.current) === null ||
                        _formRef$current5 === void 0 ||
                        (_formRef$current5$get = _formRef$current5.getFieldsFormatValue) === null ||
                        _formRef$current5$get === void 0
                        ? void 0
                        : _formRef$current5$get.call(_formRef$current5, undefined, false),
                    ).reduce(function (pre, next) {
                      ...
                      return _objectSpread(
                        ...
                        _defineProperty(
                          {},
                          next,
                          (_finalValues$next = finalValues[next]) !== null &&
                            _finalValues$next !== void 0
                            ? _finalValues$next
                            : undefined,
                        ),
                      );
  ...
  return wrapSSR(
    /*#__PURE__*/ _jsx(EditOrReadOnlyContext.Provider, {
      value: {
                ...
                _objectSpread(
                  {
                    onKeyPress: function onKeyPress(event) {
                      ...
                      if (event.key === "Enter") {
                        ...
                        (_formRef$current6 = formRef.current) === null ||
                          _formRef$current6 === void 0 ||
                          _formRef$current6.submit();
                      }
                    },
                    autoComplete: "off",
                    form: form,
                ...
                {},
                {
                  ref: function ref(instance) {
                    ...
                    formRef.current.nativeElement =
                      instance === null || instance === void 0 ? void 0 : instance.nativeElement;
                  },
                  // 组合 urlSearch 和 initialValues
                  initialValues: syncToUrlAsImportant
                    ? _objectSpread(
                        _objectSpread(_objectSpread({}, initialValues), initialData),
                        urlParamsMergeInitialValues,
                      )
                    : _objectSpread(
                        _objectSpread(
                          _objectSpread({}, urlParamsMergeInitialValues),
                          initialValues,
                        ),
                        initialData,
                      ),
                  onValuesChange: function onValuesChange(changedValues, values) {
                    ...
                    propRest === null ||
                      propRest === void 0 ||
                      (_propRest$onValuesCha = propRest.onValuesChange) === null ||
                      _propRest$onValuesCha === void 0 ||
                      _propRest$onValuesCha.call(
                        propRest,
