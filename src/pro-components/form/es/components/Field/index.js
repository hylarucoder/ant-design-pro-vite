...
var BaseProFormField = function BaseProFormField(props) {
  ...
  var childrenRender = useMemo(
              ...
              {},
              {
                onChange: function onChange() {
                  ...
                  if (fieldProps !== null && fieldProps !== void 0 && fieldProps.onChange) {
                    ...
                    fieldProps === null ||
                      fieldProps === void 0 ||
                      (_fieldProps$onChange2 = fieldProps.onChange) === null ||
                      _fieldProps$onChange2 === void 0 ||
                      _fieldProps$onChange2.call.apply(
                        _fieldProps$onChange2,
                        [fieldProps].concat(restParams),
                      );
                    return;
                  }
    ...
    [
      children,
      fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.onChange,
      _onChange,
      restProps,
    ],
  );
  ...
  return /*#__PURE__*/ _jsx(
    ...
    _objectSpread(
      ...
      {
        mode:
          (proFieldProps === null || proFieldProps === void 0 ? void 0 : proFieldProps.mode) ||
          modeContext.mode ||
          "edit",
        params: propsParams,
      },
...
var ProFormField = createField(
  /*#__PURE__*/ memo(BaseProFormField, function (prevProps, nextProps) {
