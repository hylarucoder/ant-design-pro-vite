...
var FieldSet = function FieldSet(props) {
  ...
  var fieldSetOnChange = useRefFunction(function (fileValue, index) {
    ...
    fieldProps === null ||
      ...
      _fieldProps$onChange.call(fieldProps, newValues);
  });
  var itemIndex = -1;
  var list = toArray(runFunction(children, value, props)).map(function (item) {
    if (/*#__PURE__*/ React.isValidElement(item)) {
      ...
      var isProFromItem =
        ...
        _item$type === void 0
          ? void 0
          : _item$type.displayName) === "ProFormComponent" ||
        (item === null ||
        item === void 0 ||
        (_item$props = item.props) === null ||
        _item$props === void 0
          ? void 0
          : _item$props.readonly);
      var forkProps = isProFromItem
        ? _objectSpread(
            _objectSpread(
              {
                key: index,
            ...
            {},
            {
              ...
              fieldProps: _objectSpread(
                _objectSpread(
                  ...
                  item === null ||
                    item === void 0 ||
                    (_item$props2 = item.props) === null ||
                    _item$props2 === void 0
                    ? void 0
                    : _item$props2.fieldProps,
                ),
                {},
                {
        ...
        : _objectSpread(
            ...
            {},
            {
              ...
              onChange: function onChange(itemValue) {
                ...
                (_props$onChange = (_props = item.props).onChange) === null ||
                  _props$onChange === void 0 ||
                  _props$onChange.call(_props, itemValue);
              },
            },
          );
  ...
  var Wrapper = useCallback(
    function (_ref) {
      var dom = _ref.children;
      return /*#__PURE__*/ _jsx(
        Components,
        _objectSpread(
          _objectSpread(_objectSpread({}, typeProps), space),
          {},
          {
            align: "start",
            wrap: true,
