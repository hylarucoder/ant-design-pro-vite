...
function BetaSchemaForm(props) {
  ...
  var onValuesChange = useCallback(
    function (changedValues, values) {
      ...
      propsOnValuesChange === null ||
        propsOnValuesChange === void 0 ||
        propsOnValuesChange(changedValues, values);
    },
    [propsRef, shouldUpdate],
  );
  var formChildrenDoms = useDeepCompareMemo(
    function () {
    ...
    [
      columns,
      restProps === null || restProps === void 0 ? void 0 : restProps.open,
      action,
      type,
      formDomsDeps,
    ],
   ...
   */
  var specificProps = useDeepCompareMemo(
    function () {
  ...
  return /*#__PURE__*/ _jsx(
    ...
    _objectSpread(
      _objectSpread(_objectSpread({}, specificProps), restProps),
      {},
      {
        onInit: function onInit(_, initForm) {
          ...
          restProps === null ||
            restProps === void 0 ||
            (_restProps$onInit = restProps.onInit) === null ||
            _restProps$onInit === void 0 ||
            _restProps$onInit.call(restProps, _, initForm);
