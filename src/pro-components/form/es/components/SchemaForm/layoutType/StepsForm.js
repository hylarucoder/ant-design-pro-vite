...
var StepsForm = function StepsForm(_ref) {
   ...
   */
  var onCurrentChange = useCallback(
    function (current) {
      var _propsRef$current$onC, _propsRef$current;
      (_propsRef$current$onC = (_propsRef$current = propsRef.current).onCurrentChange) === null ||
        _propsRef$current$onC === void 0 ||
        _propsRef$current$onC.call(_propsRef$current, current);
      forceUpdate([]);
    },
    [forceUpdate, propsRef],
  );
  var StepDoms = useMemo(
    function () {
      return steps === null || steps === void 0
        ? void 0
