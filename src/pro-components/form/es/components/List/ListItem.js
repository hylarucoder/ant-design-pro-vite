...
var ProFormListItem = function ProFormListItem(props) {
  ...
  var _ref = ((_ConfigProvider$useCo = ConfigProvider.useConfig) === null ||
  ...
  var getCurrentRowData = function getCurrentRowData() {
    return formInstance.getFieldValue(
      [
        ...
        originName,
        index === null || index === void 0 ? void 0 : index.toString(),
      ]
        .flat(1)
  ...
  var formListAction = {
    ...
    setCurrentRowData: function setCurrentRowData(data) {
      ...
      var oldTableDate =
        (formInstance === null ||
        formInstance === void 0 ||
        (_formInstance$getFiel = formInstance.getFieldsValue) === null ||
        _formInstance$getFiel === void 0
          ? void 0
          : _formInstance$getFiel.call(formInstance)) || {};
      var rowKeyName = [
        listContext.listName,
        originName,
        index === null || index === void 0 ? void 0 : index.toString(),
      ...
      var updateValues = set(
        oldTableDate,
        rowKeyName,
        _objectSpread(_objectSpread({}, getCurrentRowData()), data || {}),
      );
      return formInstance.setFieldsValue(updateValues);
    },
  };
  var childrenArray = listToArray(children)
    .map(function (childrenItem) {
      if (typeof childrenItem === "function") {
        return childrenItem === null || childrenItem === void 0
          ? void 0
          : childrenItem(
              field,
              index,
              _objectSpread(_objectSpread({}, action), formListAction),
              count,
            );
      }
      return childrenItem;
          ...
          _objectSpread(
            {
              key:
                ...
                (childrenItem === null ||
                childrenItem === void 0 ||
                (_childrenItem$props = childrenItem.props) === null ||
                _childrenItem$props === void 0
                  ? void 0
                  : _childrenItem$props.name) ||
                itemIndex,
            },
                      ...
                      while (1)
                        switch ((_context.prev = _context.next)) {
                          case 0:
                            setLoadingCopy(true);
                            row =
                              formInstance === null || formInstance === void 0
                                ? void 0
    ...
    actions.length > 0 && mode !== "read"
      ? /*#__PURE__*/ _jsx("div", {
          className: classNames(
            "".concat(prefixCls, "-action"),
            _defineProperty({}, "".concat(prefixCls, "-action-small"), componentSize === "small"),
            hashId,
          ),
          children: actions,
        })
  ...
  var options = {
    ...
    record:
      formInstance === null ||
      formInstance === void 0 ||
      (_formInstance$getFiel2 = formInstance.getFieldValue) === null ||
      _formInstance$getFiel2 === void 0
        ? void 0
        : _formInstance$getFiel2.call(
            formInstance,
            [listContext.listName, originName, field.name]
              .filter(function (item) {
                return item !== undefined;
  ...
  var itemContainer =
    (itemContainerRender === null || itemContainerRender === void 0
      ? void 0
      : itemContainerRender(childrenArray, options)) || childrenArray;
  var contentDom =
    (itemRender === null || itemRender === void 0
      ? void 0
      : itemRender(
          {
    ...
    /*#__PURE__*/ _jsxs("div", {
      className: classNames(
        ...
        _defineProperty(
          _defineProperty(
            {},
            "".concat(prefixCls, "-item-default"),
            alwaysShowItemLabel === undefined,
          ),
          "".concat(prefixCls, "-item-show-label"),
          alwaysShowItemLabel,
        ),
      ),
      style: {
