...
function ProFormList(props) {
  ...
  useImperativeHandle(
    ...
    function () {
      return _objectSpread(
        _objectSpread({}, actionRefs.current),
        {},
        {
          get: function get(index) {
            return proFormContext.formRef.current.getFieldValue(
              [].concat(_toConsumableArray(name), [index]),
            );
          },
  ...
  useEffect(
    function () {
      ...
      setFieldValueType(
        [props.name].flat(1).filter(function (itemName) {
                  ...
                  {},
                  {
                    ...
                    children: function children(fields, action, meta) {
                      ...
                      return /*#__PURE__*/ _jsxs(RowWrapper, {
                        children: [
                          /*#__PURE__*/ _jsx(ProFormListContainer, {
                            name: name,
                            readonly: !!readonly,
                            ...
                            onAfterAdd: function onAfterAdd(defaultValue, insertIndex, count) {
                              ...
                              _onAfterAdd === null ||
                                _onAfterAdd === void 0 ||
                                _onAfterAdd(defaultValue, insertIndex, count);
                            },
                            onAfterRemove: function onAfterRemove(index, count) {
                              ...
                              _onAfterRemove === null ||
                                _onAfterRemove === void 0 ||
                                _onAfterRemove(index, count);
                            },
