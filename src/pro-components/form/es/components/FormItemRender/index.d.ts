...
type GetArrayFieldType<
  T extends readonly {
    name: string;
  }[],
> = T[number]["name"];
export declare function useControlModel<T extends FormControlProps>(
...
export declare function useControlModel<const T extends readonly FormControlMultiProps[]>(
  { value, onChange, id }: WithControlPropsType,
  model?: T,
): {
 ...
 * ```
 */
export declare function FormControlRender(
 ...
 * ```
 */
export declare function withFormItemRender<T extends React.FC<any>>(
  Comp: T,
): React.FC<
 ...
 * ```
 */
export declare const FormItemRender: React.FC<
  Omit<import("antd").FormItemProps<unknown>, "children"> & {
    children: (formItemProps: FormControlInjectProps) => React.ReactNode;
  }
>;
/**
 ...
 * ```
 */
export declare const ProFormItemRender: React.FC<
  Omit<
