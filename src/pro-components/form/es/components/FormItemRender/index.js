...
export function useControlModel(_ref, model) {
  ...
  if (!Array.isArray(model)) {
    ...
    return _defineProperty(_defineProperty({}, p.valuePropName, value), p.trigger, function (e) {
      onChange === null ||
        onChange === void 0 ||
        onChange(e !== null && e !== void 0 && e.target ? e.target[p.valuePropName] : e);
    });
  }
  return model.reduce(function (acc, k) {
    var p = getControlConfigProps(k);
    var name = p.name || k;
    acc[name] = _defineProperty(
      _defineProperty(
        {},
        p.valuePropName,
          ...
          onChange(
            _objectSpread(
              ...
              _defineProperty(
                {},
                name,
                v !== null && v !== void 0 && v.target ? v.target[p.valuePropName] : v,
              ),
            ),
          );
      },
  ...
  return {
    ...
    onChange: function onChange(value) {
      return props.onChange(
        value !== null && value !== void 0 && value.target ? value.target.value : value,
      );
    },
  };
}
...
export function pickControlPropsWithId(props) {
  return _objectSpread(
    _objectSpread({}, pickControlProps(props)),
    {},
    {
      id: props.id,
    },
