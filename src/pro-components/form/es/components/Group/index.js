  ...
  var Wrapper = useCallback(
    function (_ref) {
      ...
      return /*#__PURE__*/ _jsx(
        Space,
        _objectSpread(
          _objectSpread({}, spaceProps),
          {},
          {
            className: classNames(
              "".concat(className, "-container ").concat(hashId),
    ...
    /*#__PURE__*/ _jsx(ColWrapper, {
      children: /*#__PURE__*/ _jsxs("div", {
        className: classNames(
          className,
          hashId,
          _defineProperty({}, "".concat(className, "-twoLine"), labelLayout === "twoLine"),
        ),
        style: style,
        ref: ref,
        children: [
